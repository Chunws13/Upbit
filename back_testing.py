...
class Back_Testing:
    def __init__(self, seed, duration):
        ...
        for day in range(duration, 0, -1):
            self.duration.append(self.start_date - datetime.timedelta(days=day) - datetime.timedelta(days=60))
    ...
    def simulate(self):
        for day in self.duration:
            ...
            # coin_list = select_coin_market(bull_market=bull_market, target_date=day, invest_number=2) # 거래량 기준 상위 n 개 선택
            # coin_list = ["KRW-BTC"]
            ...
            for coin in coin_list:
                ...
                chart = pyupbit.get_ohlcv_from(ticker = coin, interval = "day", fromDatetime = day - datetime.timedelta(days=1), to = day)
...
if __name__ == "__main__":
    setting = Back_Testing(100000, 30)
    setting.simulate()
